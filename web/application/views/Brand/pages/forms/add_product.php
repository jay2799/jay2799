            ...
            <div class="card-body">
               ...
               <form class="forms-sample" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
					...
					?>
					  <input id="brand" class="form-control" type="text"  value="<?php echo $brand['bname'];?>"  readonly>
					  <input id="brand" class="form-control" type="hidden" name="brand" value="<?php echo $brand['id'];?>"  >
                  </div>
                  <div class="form-group">
                 ...
                 <div class="table-repsonsive mb-3">
                  ...
                  <table class="table table-bordered" id="item_table">
                    <thead>
                      <tr>
                        ...
                        <th>Variant Code</th>
                        <th>Variant Image</th>
                        <th><button type="button" name="add" class="btn btn-success btn-xs add"><span><i class="ti-plus"></i></span></button></th>
                      </tr>
                    </thead>
                    <tbody></tbody>
                  </table>
				  ...
				  <div class="form-group">
                     ...
                     <input id="product_image" class="form-control" type="file" name="product_image[]" multiple>
                  </div>
