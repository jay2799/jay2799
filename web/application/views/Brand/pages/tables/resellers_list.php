					  ...
					  ?>		
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <a class="btn btn-outline-danger btn-fw" href="<?php echo base_url('brand/delete_resellers/').$re['id'];?>"><i class="ti-trash"></i></a>
							  
							  <a class="btn btn-outline-success btn-fw" href="<?php echo base_url('brand/edit_resellers/').$re['id'];?>"><i class="ti-pencil-alt"></i></a>
