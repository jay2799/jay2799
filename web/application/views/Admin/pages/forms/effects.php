   ...
   <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               <?php
                  $effectsa= $this->session->flashdata('effects');
               ...
               <?php
                  ...
                  ?>
               <form class="forms-sample" method="POST" action="<?php echo base_url('admin/update_effects'); ?>" enctype="multipart/form-data">
                  <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" id="cat_value" multiple="multiple" name="categories[]" required>
                        ...
                        <?php $filter = $this->db->get_where('filter',array('id' =>5))->row_array();?>
                        <?php 
                  ...
                  <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" multiple="multiple" id="new_sub" name="sub_cat[]" required>
                        ...
                        <?php 
                           ...
                           foreach($subcategories as $sub_cat) {
                           ?>
                        <?php $subcate=explode(",", $effe->sub_cat); ?>
                        <option <?php if(in_array($sub_cat['id'],$subcate)) { ?> selected <?php } else{} ?>  value="<?php echo $sub_cat['id']; ?>"><?php echo $sub_cat['sname']; ?></option>
                        <?php } ?>
                     </select>
                  </div>
                  <div class="form-group">
                     <label for="exampleInputUsername1">Effects Name</label>
                     <input type="text" name="effects" value="<?php echo $effe->effects; ?>"  class="form-control" id="exampleInputUsername1" placeholder="Enter Effects Name">
                  </div>
                  <button name="submit" type="submit" class="btn btn-gradient-primary mr-2">Submit</button>
               </form>
            </div>
...
<div class="content-wrapper">
   <div class="card">
      <div class="card-body">
         <h4 class="card-title">Effects List</h4>
         <div class="row">
            <div class="col-12">
               <div class="table-responsive">
                  <table id="order-listing" class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td><?php echo $no; ?></td>
                           <td><?php echo $ef['effects'];?></td>
                           <td>
                              <?php if(!empty($ef['cat'])) { ?>
                              <?php $categories=explode(",", $ef['cat']);
                           ...
                           <td>
                              <?php if(!empty($ef['sub_cat'])) { ?> 
                              <?php $subcategories=explode(",", $ef['sub_cat']);
                           ...
                           <td>
                              <a class="btn btn-outline-danger btn-fw" href="<?php echo base_url('admin/delete_effects/').$ef['id'];?>"><i class="ti-trash"></i></a>
                              <a class="btn btn-outline-success btn-fw" href="<?php echo base_url('admin/edit_effects/').$ef['id'];?>"><i class="ti-pencil-alt"></i></a>
                           </td>
                        </tr>
                        <?php } ?> 
                     </tbody>
