<div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Gallery Update</h4>
                 <?php
				...
				?>
                  <form class="forms-sample" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Category Name</label>
						...
						<select class="js-example-basic-single w-100" name="cname" >
						  ...
						  ?>
						  <option <?php if( $cat['id'] == $gallery->cname) { ?> selected <?php } else { } ?> value="<?php echo $cat['id']; ?>"><?php echo $cat['cname']; ?></option>
                    ...
                    <div class="form-group">
                        <label for="Profile">Gallery Image</label>
