<div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Catalogue Create</h4>
                 <?php
				...
				?>
                  <form class="forms-sample" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Brand Name</label>
						...
						<select class="js-example-basic-single w-100" name="brand" >
						  ...
						  ?>
						  <option value="<?php echo $br['id']; ?>"><?php echo $br['bname']; ?></option>
					...
					<div class="form-group">
                      ...
                      <input type="text" name="title"  class="form-control" id="exampleInputUsername1" placeholder="Enter Catalogue Title">
                    </div>
                    <div class="form-group">
