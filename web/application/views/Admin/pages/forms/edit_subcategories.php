				...
				?>
                  <form class="forms-sample" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Category Name</label>
						...
						<select class="js-example-basic-single w-100" name="cname" >
						  ...
						  ?>
						  <option <?php if($subcategories->cname == $cat['id']) {  ?> selected <?php } else {} ?>  value="<?php echo $cat['id']; ?>"><?php echo $cat['cname']; ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="sname" value="<?php echo $subcategories->sname;?>"  class="form-control" id="exampleInputUsername1" placeholder="Enter Sub Category Name">
                    </div>
