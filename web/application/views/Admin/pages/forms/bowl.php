            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 ...
                 <?php
				  $bowla= $this->session->flashdata('bowl');
				...
				?>
                  ...
                  <form class="forms-sample" method="POST" action="<?php echo base_url('admin/update_bowl'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" id="cat_value" multiple="multiple" name="categories[]" required>
						...
						<?php $filter = $this->db->get_where('filter',array('id' =>14))->row_array();?>
                        <?php 
                  ...
                  <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" multiple="multiple" id="new_sub" name="sub_cat[]" required>
                        ...
                        <?php 
                           ...
                           foreach($subcategories as $sub_cat) {
                           ?>
                        <?php $subcate=explode(",", $bow->sub_cat); ?>
                        <option <?php if(in_array($sub_cat['id'],$subcate)) { ?> selected <?php } else{} ?>  value="<?php echo $sub_cat['id']; ?>"><?php echo $sub_cat['sname']; ?></option>
                        <?php } ?>
                     </select>
                  </div>
                  <div class="form-group">
                     <label for="exampleInputUsername1">Bowl</label>
                     <input type="text" name="bowl" value="<?php echo $bow->bowl; ?>"  class="form-control" id="exampleInputUsername1" placeholder="Enter Bed Size">
                  </div>
                  <button name="submit" type="submit" class="btn btn-gradient-primary mr-2">Submit</button>
               </form>
            </div>
...
<div class="content-wrapper">
   <div class="card">
      <div class="card-body">
         <h4 class="card-title">Bowl List</h4>
         <div class="row">
            <div class="col-12">
               <div class="table-responsive">
                  <table id="order-listing" class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td><?php echo $no; ?></td>
                           <td><?php echo $bo['bowl'];?></td>
						   <td>
                              <?php if(!empty($bo['cat'])) { ?>
                              <?php $categories=explode(",", $bo['cat']);
                           ...
                           <td>
                              <?php if(!empty($bo['sub_cat'])) { ?> 
                              <?php $subcategories=explode(",", $bo['sub_cat']);
                           ...
                           <td>
                              <a class="btn btn-outline-danger btn-fw" href="<?php echo base_url('admin/delete_bowl/').$bo['id'];?>"><i class="ti-trash"></i></a>
                              <a class="btn btn-outline-success btn-fw" href="<?php echo base_url('admin/edit_bowl/').$bo['id'];?>"><i class="ti-pencil-alt"></i></a>
                           </td>
                        </tr>
                        <?php } ?> 
                     </tbody>
