				...
				?>
                  <form class="forms-sample" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" name="title" value="<?php echo $blog->title; ?>"  class="form-control" id="exampleInputUsername1" placeholder="Enter Blog Title">
                    </div>

					<div class="form-group">
                      <label for="exampleInputUsername1">Blog Description</label>
                   <textarea id='summernoteExample' name="description"><?php echo $blog->description; ?></textarea>
                    </div>
