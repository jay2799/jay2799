            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 ...
                 <?php
				  $thicknessa= $this->session->flashdata('thickness');
				...
				?>
                  ...
                  <form class="forms-sample" method="POST" action="<?php echo base_url('admin/update_thickness'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" id="cat_value" multiple="multiple" name="categories[]" required>
						...
						<?php $filter = $this->db->get_where('filter',array('id' =>8))->row_array();?>
                        <?php 
...
<div class="content-wrapper">
   <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               <h4 class="card-title">Thickness</h4>
               <?php
                  ...
                  <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" multiple="multiple" id="new_sub" name="sub_cat[]" required>
                        ...
                        <?php 
                           ...
                           foreach($subcategories as $sub_cat) {
                           ?>
                        <?php $subcate=explode(",", $thic->sub_cat); ?>
                        <option <?php if(in_array($sub_cat['id'],$subcate)) { ?> selected <?php } else{} ?>  value="<?php echo $sub_cat['id']; ?>"><?php echo $sub_cat['sname']; ?></option>
                        <?php } ?>
                     </select>
                  </div>
                  <div class="form-group">
                     <label for="exampleInputUsername1">Thickness</label>
                     <input type="text" name="thickness" value="<?php echo $thic->thickness; ?>"  class="form-control" id="exampleInputUsername1" placeholder="Enter Thickness">
                  </div>
                  <button name="submit" type="submit" class="btn btn-gradient-primary mr-2">Submit</button>
               </form>
            </div>
...
<div class="content-wrapper">
   <div class="card">
      <div class="card-body">
         <h4 class="card-title">Thickness List</h4>
         <div class="row">
            <div class="col-12">
                  ...
                  <table id="order-listing" class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <a class="btn btn-outline-danger btn-fw" href="<?php echo base_url('admin/delete_thickness/').$th['id'];?>"><i class="ti-trash"></i></a>
                              <a class="btn btn-outline-success btn-fw" href="<?php echo base_url('admin/edit_thickness/').$th['id'];?>"><i class="ti-pencil-alt"></i></a>
                           </td>
                        </tr>
                        <?php } ?> 
                     </tbody>
