            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 ...
                 <?php
				  $number_of_seata= $this->session->flashdata('number_of_seat');
				  $error_msg= $this->session->flashdata('error_msg');

				  if($number_of_seata){
					?>
					<div class="alert alert-success" role="alert">
						<?php echo $number_of_seata; ?>
                    </div>
				  <?php
				  }
				  if($error_msg){
				...
				?>
                  ...
                  <form class="forms-sample" method="POST" action="<?php echo base_url('admin/update_n_o_s'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" id="cat_value" multiple="multiple" name="categories[]" required>
						...
						<?php $filter = $this->db->get_where('filter',array('id' =>12))->row_array();?>
                        <?php 
...
<div class="content-wrapper">
   <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               <h4 class="card-title">Number Of Seat</h4>
               <?php
                  ...
                  <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" multiple="multiple" id="new_sub" name="sub_cat[]" required>
                        ...
                        <?php 
                           ...
                           foreach($subcategories as $sub_cat) {
                           ?>
                        <?php $subcate=explode(",", $num->sub_cat); ?>
                        <option <?php if(in_array($sub_cat['id'],$subcate)) { ?> selected <?php } else{} ?>  value="<?php echo $sub_cat['id']; ?>"><?php echo $sub_cat['sname']; ?></option>
                        <?php } ?>
                     </select>
                  </div>
                  <div class="form-group">
                     <label for="exampleInputUsername1">Number Of Seat</label>
                     <input type="text" name="number_of_seat" value="<?php echo $num->number_of_seat; ?>"  class="form-control" id="exampleInputUsername1" placeholder="Enter Number Of Seat">
                  </div>
                  <button name="submit" type="submit" class="btn btn-gradient-primary mr-2">Submit</button>
               </form>
            </div>
...
<div class="content-wrapper">
   <div class="card">
      <div class="card-body">
         <h4 class="card-title">Number Of Seat List</h4>
         <div class="row">
            <div class="col-12">
               <div class="table-responsive">
                  <table id="order-listing" class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td><?php echo $no; ?></td>
                           <td><?php echo $nu['number_of_seat'];?></td>
						   <td>
                              <?php if(!empty($nu['cat'])) { ?>
                              <?php $categories=explode(",", $nu['cat']);
                           ...
                           <td>
                              <?php if(!empty($nu['sub_cat'])) { ?> 
                              <?php $subcategories=explode(",", $nu['sub_cat']);
                           ...
                           <td>
                              <a class="btn btn-outline-danger btn-fw" href="<?php echo base_url('admin/delete_number_of_seat/').$nu['id'];?>"><i class="ti-trash"></i></a>
                              <a class="btn btn-outline-success btn-fw" href="<?php echo base_url('admin/edit_number_of_seat/').$nu['id'];?>"><i class="ti-pencil-alt"></i></a>
                           </td>
                        </tr>
                        <?php } ?> 
                     </tbody>
