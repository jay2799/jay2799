				...
				?>
                  <form class="forms-sample" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" value="<?php echo $user->name; ?>" class="form-control" id="exampleInputUsername1" placeholder="Enter User Name">
                    </div>
					
					<div class="form-group">
                      <label for="exampleInputUsername1">User Email</label>
                      <input type="email" name="email"  value="<?php echo $user->email; ?>" class="form-control" id="exampleInputUsername1" placeholder="Enter User Email">
                    </div>
					
					<div class="form-group">
                      <label for="exampleInputUsername1">User Mobile</label>
                      <input type="number" name="number"  value="<?php echo $user->number; ?>" class="form-control" id="exampleInputUsername1" placeholder="Enter User Number">
                    </div>
