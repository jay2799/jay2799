            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 ...
                 <?php
				  $add_color= $this->session->flashdata('add_color');
				...
				?>
                  ...
                  <form class="forms-sample" method="POST" action="<?php echo base_url('admin/update_color'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" id="cat_value" multiple="multiple" name="categories[]" required>
						...
						<?php $filter = $this->db->get_where('filter',array('id' =>15))->row_array();?>
                        <?php 
            ...
            <div class="card-body">
			   ...
			   <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple w-100" multiple="multiple" id="new_sub" name="sub_cat[]" required>
                        ...
                        <?php 
                           ...
                           foreach($subcategories as $sub_cat) {
                           ?>
                        <?php $subcate=explode(",", $color['sub_cat']); ?>
                        <option <?php if(in_array($sub_cat['id'],$subcate)) { ?> selected <?php } else{} ?>  value="<?php echo $sub_cat['id']; ?>"><?php echo $sub_cat['sname']; ?></option>
                        <?php } ?>
                     </select>
                  </div>
                  <div class="form-group">
                     ...
                     <input type="text" name="name" value="<?php echo $color['name']; ?>"  class="form-control" id="exampleInputUsername1" placeholder="Enter Color Name">
                  </div>
				  <div class="form-group">
                     <label for="exampleInputUsername1">Color Image</label>
                  ...
                  <table id="order-listing" class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
						   ...
						   <td><img src="<?php echo base_url();?>uploads/color/<?php echo $co['images'];?>"</td>
						   <td>
                              <?php if(!empty($co['cat'])) { ?>
                              <?php $categories=explode(",", $co['cat']);
                           ...
                           <td>
                              <?php if(!empty($co['sub_cat'])) { ?> 
                              <?php $subcategories=explode(",", $co['sub_cat']);
