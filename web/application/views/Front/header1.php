...
<html lang="en">
   ...
   <body class="fashon3">
      ...
      <header class="header-style-1">
            ...
            <div class="mobile-menu d-lg-none d-block">
                  ...
                  <div class="container ">
                     <div class="row">
                        <div class="menu-info d-flex justify-content-between align-items-center">
                           ...
                           <a href="<?php echo base_url();?>" class="logo"> <img src="<?php echo base_url();?>assets/img/black_logo.png" alt=""> </a>
               ...
               <div class="mobile-menu__sidebar-menu">
                  ...
                  <div class="search-box-holder">
                     <form action="#0">
                        <div class="form-group search-box menua"> <input type="text" class="form-control"
                  ...
                  <ul class="page-dropdown-menu">
                     ...
                     <?php } ?>
                     <li class="dropdown-list"> <a href="<?php echo base_url('brand-list');?>"><span>Brands</span></a></li>
                     <?php
                     ...
                     <div class="col-10 ">
                        <div class="d-flex align-items-center justify-content-between">
                           <div class="d-flex align-items-center searchclass">
                              <div class="search-box-holder desktops">
                                 <form action="#0">
                                    <div class="form-group search-box menu meanua">
                                       <input type="text" class="form-control"
                                          placeholder="search from 600+ brands and 25,000 + products">
         ...
         <div class="mega-menu-default fashonmenu3 mega-menu d-lg-block d-none">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                     <nav class="header1menu">
                        <ul class="page-dropdown-menu d-flex align-items-center justify-content-center">
                           ...
                           <?php } ?>     
                           <li class="dropdown-list "> <a href="<?php echo base_url('brand-list');?>">Brands</a></li>
                        </ul>
                     </nav>
                  </div>
               </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                           <div class="d-flex align-items-center searchclass">
                              <div class="search-box-holder desktops" style="width:100%;">
                                 <form action="#0">
                                    <div class="form-group search-box menu meanua">
                                       <input type="text" class="form-control" placeholder="search from 600+ brands and 25,000 + products" style="margin:0px !important;">
                                       <span class="search-icon"> <i class="flaticon-loupe"></i> </span>
                                    </div>
                                 </form>
                              </div>
