jQuery(function ($) {
  ...
  $(".slick").slick({
    prevArrow: '<div class="slick-arrow arrow-back"> <i class="fa-solid fa-angle-left"></i>  </div>',
    nextArrow: '<div class="slick-arrow arrow-next"> <i class="fa-solid fa-angle-right"></i> </div>'
  });
  ...
  if ($(".reviewOneSlider").length) {
    $(".reviewOneSlider").slick({
      ...
      arrows: true,
      autoplay: true,
      prevArrow: '<button class="arrow-back"><i class="fa-solid fa-angle-right"></i> </button>',
      nextArrow: '<button class="arrow-next"><i class="fa-solid fa-angle-left"></i></button>',
      autoplaySpeed: 2000,
      pauseOnHover: false,
      responsive: [{
          breakpoint: 992,
  ...
  if ($(".product-two-slider-box").length) {
    $(".product-two-slider-box").slick({
      ...
      arrows: true,
      autoplay: true,
      prevArrow: '<button class="arrow-back"><i class="fa-solid fa-angle-left"></i> </button>',
      nextArrow: '<button class="arrow-next"><i class="fa-solid fa-angle-right"></i></button>',
      autoplaySpeed: 2000,
      pauseOnHover: false,
      responsive: [{
          breakpoint: 768,
